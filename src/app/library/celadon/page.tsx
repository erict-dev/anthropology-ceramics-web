      ...
      <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        <header>
          ...
          <p className="mt-4 text-black">
            {"Celadon is a type of ceramic that originated in China, renowned for its distinctive jade-like green surface. This ancient technique, dating back to the Eastern Han Dynasty, was highly prized for its subtle yet vivid sea-green color. The allure of Celadon lies in its translucent quality and depth, which can range from very light, almost translucent greens to deep, rich moss tones. The term 'Celadon' was coined by Europeans, inspired by the ceramic's resemblance to green stones cherished in their culture."}
          </p>
        </header>
