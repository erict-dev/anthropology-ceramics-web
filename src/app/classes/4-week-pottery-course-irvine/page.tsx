      ...
      <section className="py-12">
        <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-lg text-gray-700">
            Classes run weekly for 4 weeks and are held in our studio in Irvine. Each session includes two hours of guided instruction. Spots are limited and often fill up.
          </p>
