    ...
    <section>
      <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        <div className="mb-8">
          ...
          <p className="mt-4 text-black">Come join us for a pottery class! We host group pottery classes in our beautiful backyard studio located in Irvine, CA. If you have questions about our class or want to book a private class for your family, friend group or organization, feel free to email us at olomanastudios@gmail.com.</p>
        </div>
