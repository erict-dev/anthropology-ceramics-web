        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 md:gap-16">
          ...
          <div>
            ...
            <p className="mt-4 text-gray-700">
              {"Welcome to Anthropology Ceramics, a serene ceramics art studio nestled in the heart of sunny Southern California. Founded by Christina and Eric, a dynamic couple who left their corporate careers behind to pursue their passion for pottery, Anthropology Ceramics is a haven for creativity and tranquility. Christina, our main artist, brings a rich background in business consulting and finance, having worked with industry giants like GE, Apollo, and McKinsey. Her journey into the world of ceramics took her from Laguna Beach to the revered pottery hubs of Mashiko and Shigaraki in Japan, and Jingdezhen in China, where she honed her skills under the tutelage of master artisans."}
            </p>
            <p className="mt-4 text-gray-700">{"Eric, our studio art manager, combines his expertise in tech and brand building with a deep appreciation for the tangible and the tactile. Having worked for tech giants such as Apple, Amazon, Blizzard, and Shopify, Eric realized the importance of grounding ourselves in the physical world, away from the constant digital noise. Together, they work to create a sanctuary where art and nature converge, offering a moment of peace and reflection in our hectic lives."}
            </p>
